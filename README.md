...
2. 👍 Approved [#46](https://github.com/ParrotXray/lava-lyra/pull/46#pullrequestreview-4943569638) in [ParrotXray/lava-lyra](https://github.com/ParrotXray/lava-lyra)<br>
3. 🎯 Pushed undefined commit(s) to [ParrotXray/lava-lyra](https://github.com/ParrotXray/lava-lyra)<br>
4. 👍 Approved [#45](https://github.com/ParrotXray/lava-lyra/pull/45#pullrequestreview-4933511256) in [ParrotXray/lava-lyra](https://github.com/ParrotXray/lava-lyra)<br>
5. 🚀 Released [v2.2.2](https://github.com/ParrotXray/lava-lyra/releases/tag/v2.2.2) in [ParrotXray/lava-lyra](https://github.com/ParrotXray/lava-lyra)<br>
<!--RECENT_ACTIVITY:end-->
